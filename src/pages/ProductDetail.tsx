...
function ProductDetail() {
    ...
    return (
        <Container maxWidth="lg">
            ...
            {
                product && <>
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', marginTop: '60px' }}>
                        <div>
                            <img src={product.image} width={250} height={400} alt='' />
                        </div>

                        <div style={{ marginLeft: '60px', marginTop: '60px' }}>
                            <div style={{ fontFamily: 'arial', fontSize: '20px' }}>{product.title}</div>
                            ...
                            <div style={{ marginTop: '20px' }}>
                                ...
                                <span style={{ fontSize: '30px', fontWeight: 'arial', marginRight: '10px' }}>{count}</span>
